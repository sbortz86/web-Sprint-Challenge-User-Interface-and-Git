...
They are tags with meaning

2. Name two big differences between ```display: block;``` and ```display: inline;```.
With inline-block top and bottom margins are respected and with inline they are not. Also block dose not add a line break after the element
...
because it allows multiple programmers to work on projects together from anywhere in the world. To see changes and work together to code
